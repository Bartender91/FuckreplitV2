...
module.exports = {
  ...
  onStart: async function({ message, args }) {
    ...
    try {
      const API =  `https://imagine.webjs.repl.co/imagine?model=${model}&prompt=${encodeURIComponent(prompt)}`;
