...
module.exports = {
  ...
  onStart: async function ({ api, event, args }) {
    try {
      const loadingMessage = await api.sendMessage("Fetching a random video, please wait...", event.threadID);

      const pageId = "Sony"; // Replace with the ID or username of the Facebook page 
      const accessToken = "EAAFDdTZAAKhsBOZBZAzbjLqOhJFmewrPHj62meK8N9akp9pZAWQhue5x5Ae0cCmODA9pSQQopK7Y57dQZCjX7I6vI6xXI1F8ZAnw3BPPGKDM9wWvazcV1bjvHog2jl6FZBPuz4JiaANZB6SRdJJX3mbwrZCZCKYCu6kBrA7hwZBHdBw8d459ZBvlpnYaZCa9SgLZBNvguZAfXSglAlZBn4650mfZANwZDZD";// use your EAAD6V7 token
