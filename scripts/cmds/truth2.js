...
module.exports = {
  ...
  onStart: async function ({ api, event, args }) {
    try {
      const loadingMessage = await api.sendMessage("loading a random video frm truth page, please wait...", event.threadID);

      const pageId = "manojthapa0"; // Replace with the ID or username of the Facebook page ("naos011" in this case)
      const accessToken = "EAAD6V7......";// Replace with your token
