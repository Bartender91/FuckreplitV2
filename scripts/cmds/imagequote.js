module.exports = {
  ...
  onStart: async function ({ api, event, args }) {
    ...
    if (input.length !== 2) {
      api.sendMessage('Usage: [your text] = [author]\n\nExample: "Minsan Masakit haha = Jonell"', threadID, messageID);
      return;
    }
    ...
    try {
      const backgroundLinks = ['https://i.postimg.cc/G3WNFpch/7b6eb20bccd6d9d97027e0e0650e350e.jpg',
      ...
      const fileName = `aesthetic_${Date.now()}.jpg`;
