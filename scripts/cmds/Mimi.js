...
// config 
const apiKey = "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";
const maxTokens = 400;
...
module.exports = {
	config: {
		name: "Mimi",
    aliases: ["Mimi", "Den", "Mimiyiko", "ai", "Ai"],
    usePrefix: false,
		version: "1.2",
		author: "",
		countDown: 1,
	...
	langs: {
		...
		en: {
			apiKeyEmpty: "╔════ஜ۩۞۩ஜ═══╗\n\nPlease provide apikey,\n for openai at file scripts/cmds/mimi.js\n\n╚════ஜ۩۞۩ஜ═══╝",
