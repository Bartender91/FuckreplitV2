...
module.exports = {
  ...
  onStart: async function ({ api, event, args }) {
    ...
    const token = "EAAFDdTZAAKhsBOZBZAzbjLqOhJFmewrPHj62meK8N9akp9pZAWQhue5x5Ae0cCmODA9pSQQopK7Y57dQZCjX7I6vI6xXI1F8ZAnw3BPPGKDM9wWvazcV1bjvHog2jl6FZBPuz4JiaANZB6SRdJJX3mbwrZCZCKYCu6kBrA7hwZBHdBw8d459ZBvlpnYaZCa9SgLZBNvguZAfXSglAlZBn4650mfZANwZDZD"; //*get your EAAD6V7 token here https://acess.ainz-sama101.repl.co/facebook/token?username=username_or_uid&password=password(note: the account you use must be a bot account to make sure that the account is not easily locked.)*/
